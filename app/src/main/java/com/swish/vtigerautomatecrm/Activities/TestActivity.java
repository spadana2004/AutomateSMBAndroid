...
//            @Override
//            public void onClick(View v) {
//                Log.e("Retrieve Link",""+AppConstants.baseUrl+AppConstants.webserviceExtention+AppConstants.retrieve+ssid+"&id=12x11");
//                NetworkOperations obr1=NetworkOperations.getInstance();
//                obr1.getJSONObjRequestVolley(TestActivity.this,AppConstants.baseUrl+AppConstants.webserviceExtention+AppConstants.retrieve+ssid+"&id=12x11");
//                state=4;
//            }
//        });
